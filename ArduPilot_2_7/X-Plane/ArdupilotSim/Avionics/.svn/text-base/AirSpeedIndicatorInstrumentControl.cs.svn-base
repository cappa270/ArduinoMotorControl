...
namespace AvionicsInstrumentControlDemo
{
    class AirSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(ArdupilotSim.Avionics.AvionicsInstrumentsControlsRessources.AirSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(ArdupilotSim.Avionics.AvionicsInstrumentsControlsRessources.AirSpeedNeedle);
