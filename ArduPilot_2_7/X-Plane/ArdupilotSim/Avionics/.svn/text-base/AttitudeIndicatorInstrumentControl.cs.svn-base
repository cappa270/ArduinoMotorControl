...
namespace AvionicsInstrumentControlDemo
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(ArdupilotSim.Avionics.AvionicsInstrumentsControlsRessources.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(ArdupilotSim.Avionics.AvionicsInstrumentsControlsRessources.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(ArdupilotSim.Avionics.AvionicsInstrumentsControlsRessources.Maquette_Avion);
