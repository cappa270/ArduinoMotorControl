...
namespace AvionicsInstrumentControlDemo
{
    class HeadingIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(ArdupilotSim.Avionics.AvionicsInstrumentsControlsRessources.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(ArdupilotSim.Avionics.AvionicsInstrumentsControlsRessources.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(ArdupilotSim.Avionics.AvionicsInstrumentsControlsRessources.HeadingIndicator_Aircraft);        
