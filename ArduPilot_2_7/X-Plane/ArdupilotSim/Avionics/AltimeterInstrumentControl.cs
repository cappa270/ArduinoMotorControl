...
namespace AvionicsInstrumentControlDemo
{
    class AltimeterInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(ArdupilotSim.Avionics.AvionicsInstrumentsControlsRessources.Altimeter_Background);
        Bitmap bmpSmallNeedle = new Bitmap(ArdupilotSim.Avionics.AvionicsInstrumentsControlsRessources.SmallNeedleAltimeter);
        Bitmap bmpLongNeedle = new Bitmap(ArdupilotSim.Avionics.AvionicsInstrumentsControlsRessources.LongNeedleAltimeter);
        Bitmap bmpScroll = new Bitmap(ArdupilotSim.Avionics.AvionicsInstrumentsControlsRessources.Bandeau_Dérouleur);
