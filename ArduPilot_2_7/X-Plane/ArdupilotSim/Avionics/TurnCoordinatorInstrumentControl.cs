...
namespace AvionicsInstrumentControlDemo
{
    class TurnCoordinatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(ArdupilotSim.Avionics.AvionicsInstrumentsControlsRessources.TurnCoordinator_Background);
        Bitmap bmpBall = new Bitmap(ArdupilotSim.Avionics.AvionicsInstrumentsControlsRessources.TurnCoordinatorBall);
        Bitmap bmpAircraft = new Bitmap(ArdupilotSim.Avionics.AvionicsInstrumentsControlsRessources.TurnCoordinatorAircraft);
        Bitmap bmpMarks = new Bitmap(ArdupilotSim.Avionics.AvionicsInstrumentsControlsRessources.TurnCoordinatorMarks);
