...
void loop(){
    if(Serial.available()>0){
        ...
        if(newData && checksum_is_true()){
            ...
            //Serial.println(serialPackets[0].word);
            Serial.println(serialPackets[1].word/100);
            //Serial.println(serialPackets[1].word);
            Serial.println(serialPackets[2].word/100);
            //Serial.println(serialPackets[2].word);
            
            if(serialPackets[2].word/100 < 128){
