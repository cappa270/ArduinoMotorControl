...
// motor control pins
// Arduino pin 11 == pin 10 on bridge
int motor1_forward = 11;
// Arduino pin 10 == pin 12 on bridge
int motor1_reverse = 10;
// Arduino pin 5 == pin 7 on bridge
int motor2_forward = 5;
// Arduino pin 6 == pin 5 on bridge
int motor2_reverse = 6;
...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    // the throttle value equal to the one provided by the user
